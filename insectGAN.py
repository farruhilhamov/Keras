...
parser()
my_collection = np.array(my_collection)
n = len(my_collection)
print(n)
my_collection = np.reshape(my_collection,(-1,2,2))

my_collection = [[my_collection[:n/4],my_collection[n/4:n/2]],[my_collection[n/2:n/3/4],my_collection[n/3/4:]]]  #np.reshape(my_collection,(-1,2,2))
(x_train, y_train), (x_test, y_test) = my_collection
# data = mnist.load_data()

# print(my_collection.shape)
